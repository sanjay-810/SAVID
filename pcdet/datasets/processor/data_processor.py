...
class DataProcessor(object):
    ...
    def mask_points_and_boxes_outside_range_savid(self, data_dict=None, config=None):
        if data_dict is None:
            return partial(self.mask_points_and_boxes_outside_range_savid, config=config)
    ...
    def shuffle_points_savid(self, data_dict=None, config=None):
        if data_dict is None:
            return partial(self.shuffle_points_savid, config=config)
