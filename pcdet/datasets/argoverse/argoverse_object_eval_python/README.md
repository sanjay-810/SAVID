# argoverse-object-eval-python
**Note**: This is borrowed from [traveller59/argoverse-object-eval-python](https://github.com/traveller59/argoverse-object-eval-python)

Fast argoverse object detection eval in python(finish eval in less than 10 second), support 2d/bev/3d/aos. , support coco-style AP. If you use command line interface, numba need some time to compile jit functions.
## Dependencies
...
* python interface:
```Python
import argoverse_common as argoverse
...
dt_annos = argoverse.get_label_annos(det_path)
...
gt_annos = argoverse.get_label_annos(gt_path, val_image_ids)
