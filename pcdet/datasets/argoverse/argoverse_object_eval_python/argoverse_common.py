...
def get_argoverse_info_path(idx,
                        prefix,
                        info_type='image_2',
                        file_tail='.png',
                        training=True,
...
def get_image_path(idx, prefix, training=True, relative_path=True):
    return get_argoverse_info_path(idx, prefix, 'image_2', '.png', training,
                               relative_path)


def get_label_path(idx, prefix, training=True, relative_path=True):
    return get_argoverse_info_path(idx, prefix, 'label_2', '.txt', training,
                               relative_path)


def get_velodyne_path(idx, prefix, training=True, relative_path=True):
    return get_argoverse_info_path(idx, prefix, 'velodyne', '.bin', training,
                               relative_path)


def get_calib_path(idx, prefix, training=True, relative_path=True):
    return get_argoverse_info_path(idx, prefix, 'calib', '.txt', training,
                               relative_path)
...
def get_argoverse_image_info(path,
                         training=True,
                         label_info=True,
                         velodyne=False,
                         calib=False,
...
def filter_argoverse_anno(image_anno,
                      used_classes,
...
def argoverse_result_line(result_dict, precision=4):
